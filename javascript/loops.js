 ...
 * user for the magic number until they enter the value "7". (What's prompt?
 * Check MDN!)
 */
 ...
 * Prompt:
 *
 * Write a for loop that counts from 0 to 5. Log each number to the console.
 */

/*
 * Prompt:
 *
 * Write a for loop that counts down from 5 to 0. Log each number to the
 * console.
 */
 ...
 * Prompt:
 *
 * Write a for loop that counts from 0 to 10 in increments of 2. Log each number
 * to the console.
 */
 ...
 * Prompt:
 *
 * Write a for loop that sums the values in the below array. Print the sum out
 * to the console.
 */
 ...
 * Prompt:
 *
 * Write a for loop that doubles each value in the following array. Print the
 * array out to the console.
 */
 ...
 * Prompt:
 *
 * Write a for loop that sets a variable to the largest number in the following array. Print that number out to the console.
 */

const evenMoreNumbers = [12, 45, 23, 999, 7];
